 ...
 * @see https://v0.dev/t/76WXnfdXpeP
                ...
                <ul className="grid gap-6">
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-gray-500 dark:text-gray-400">
                        Create and manage your budget to ensure you're staying
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  ...
                  best for you, whether it's the 50/30/20 rule, the envelope
                  system, or a custom approach. We provide the tools to make any
                  budgeting strategy successful.
                </p>
              </div>
              <div className="grid w-full max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                <Card className="flex flex-col items-start space-y-4 rounded-lg border bg-white p-6 shadow-sm transition-colors hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800">
