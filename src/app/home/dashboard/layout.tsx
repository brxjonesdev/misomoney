    ...
    <div className="grid min-h-screen w-full lg:grid-cols-[280px_1fr]">
      <aside className="hidden border-r bg-gray-100/40 lg:block dark:bg-gray-800/40">
        <div className="flex h-full max-h-screen flex-col gap-2">
          <header className="flex h-fit items-center border-b px-2 justify-between">
            <a
              className="flex font-semibold  p-2 w-full justify-between"
              href="#"
            >
              <div className="flex flex-col">
                <span className="text-xl font-bold">MisoMoney</span>
                <span className="text-xs font-normal">
                  created with love by brx
                </span>
              </div>
              <ModeToggle />
            </a>
